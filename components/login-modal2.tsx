  ...
  return (
      <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50">
        <div className="relative flex w-full max-w-4xl overflow-hidden rounded-lg bg-white shadow-xl">
          ...
          <div className="hidden md:block md:w-1/2 bg-green-500 hover:bg-[#7aa93c] text-white p-10">
                ...
                useEmail &&
                  <>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-4">
                      ...
                      <Button type="submit" disabled={pleaseWaitWhileYourTransactionIsProcessing} className="w-full bg-green-500 hover:bg-[rgb(110,160,44)]">
                        {
