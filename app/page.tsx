...
import { SERVER_PUBLIC, defaultCurrency, metaData, BASE_PUBLIC, PROMO_KEY } from "@/lib/utils";
...
import { AuthorPromoModal } from "@/components/author/AuthorPromoModal";
...
export default function Home() {
    ...
    const [isAuthorPromoModal, setIsAuthorPromoModal] = useState(false)

    const [heroSlides, setHeroSlides] = useState([
        {
            title: "Ready-Made Projects in Popular Frameworks",
            description: "Discover complete, production-ready projects built with React, Next.js, Laravel, WordPress, and more — all designed to help you launch faster.",
            image: "/images/ward-of-year.png?height=300&width=500",
        },
        {
            title: "Full-Stack Solutions for Every Use Case",
            description: "Browse high-quality full-stack applications and admin dashboards developed with modern stacks like MERN, LAMP, Django and more.",
            image: "/images/banner2.png?height=300&width=500",
        },
        {
            title: "Launch-Ready Templates for Developers",
            description: "Save development time with fully functional apps — from eCommerce stores to blog platforms — built using best practices.",
    ...
    useEffect(() => {
        ...
        const shouldShowModal = () => {
            ...
            const diffInHours = (now - lastShownTime) / (1000 * 60 * 60);

            return diffInHours >= 24;
        };

        if (isLoggedIn && user && !user?.isAuthor) {
            if (shouldShowModal()) {
                setTimeout(() => {
                    setIsAuthorPromoModal(true);
    ...
    return (
        ...
        >
            ...
            <AuthorPromoModal
                open={isAuthorPromoModal}
                onOpenChange={() => setIsAuthorPromoModal(false)}
